...
public class TreeMapBasics {
    public static void main(String[] args) {
       ...
       // tmap.forEach((key, value) -> System.out.println("Key: " + key + ", Value: " + value));
